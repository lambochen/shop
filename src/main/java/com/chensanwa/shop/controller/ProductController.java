...
public class ProductController {
    ...
    @ResponseBody
    public Result modifyStock(int id, int stock) {
        productService.modifyStock(id, stock);
        return ResultUtil.success();
    }

    @RequestMapping(value = "/dicount", method = RequestMethod.POST)
    @ResponseBody
    public Result modifyDiscount(int id, int dicount) {
        productService.modifyDiscount(id, dicount);
        return ResultUtil.success();
    }
